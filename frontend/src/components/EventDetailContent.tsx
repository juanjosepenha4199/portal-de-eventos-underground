...
type EventDetailContentProps = {
  ...
  dateStr: string;
  canEdit: boolean;
  /** Número de asistentes (entradas pagadas); se muestra enlace "Ver asistentes" si canEdit */
        ...
        <div className="p-6">
          ...
          {canEdit && (
            <div className="mt-6 flex flex-wrap items-center gap-2">
              ...
              <Link
                href={`/events/my/${event.id}/attendees`}
                className="bg-underground-border text-underground-fg px-4 py-2 rounded-lg text-sm font-medium hover:bg-underground-border/80 hover:shadow-neon-sm transition border border-underground-border focus-visible:outline focus-visible:outline-2 focus-visible:outline-neon-cyan focus-visible:outline-offset-2"
              >
                {t("event.viewAttendees")} {attendeesCount > 0 && `(${attendeesCount})`}
              </Link>
